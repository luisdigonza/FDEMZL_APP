...
<head>
    ...
    <title>Añadir producto - Panel administrativo - FDEMZL</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" placeholder="Ingresar nombre del producto" name="product_title" id="product_title" class="form-control" autocomplete="off" required>
                    </div>
                    <!-- description -->
                    <div class="form-outline mb-4">
                        <label for="product_description" class="form-label">Descripción del producto</label>
                        <input type="text" placeholder="Ingresar descripción del producto" name="product_description" id="product_description" class="form-control" autocomplete="off" required>
                    </div>
                    <!-- keywords -->
                    <div class="form-outline mb-4">
                        <label for="product_keywords" class="form-label">Palabras clave del producto</label>
                        <input type="text" placeholder="Ingresar Palabras clave del producto" name="product_keywords" id="product_keywords" class="form-control" autocomplete="off" required>
                    </div>
                    <!-- categories -->
                    <div class="form-outline mb-4">
                    ...
                    <div class="form-outline mb-4">
                        <select class="form-select" name="product_brand" id="product_brand">
                            <option selected disabled>Seleccionar etiqueta</option>
                            <?php
                    ...
                    <div class="form-outline mb-4">
                        <input type="submit" value="Añadir producto" name="insert_product" class="btn btn-primary">
                    </div>
                </div>
                <div class="col-md-5">    
                    <!-- Image one -->
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="number" placeholder="Añadir precio del producto" name="product_price" id="product_price" class="form-control" autocomplete="off">
                    </div>
                    <!--  -->
