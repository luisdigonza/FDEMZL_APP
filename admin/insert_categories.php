...
if (isset($_POST['insert_categ_title'])) {
    ...
    if ($numOfResults > 0) {
        ...
        if ($insert_result){
            echo "<script>alert('La categoría se ha añadido correctamente');</script>";
        }
    }
}
?>
...
<form action="" method="POST" class="mb-2">
    <div class="input-group w-90 mb-3">
        ...
        <input type="text" class="form-control" name="categ_title" placeholder="Añadir Categorias" aria-label="categories" aria-describedby="basic-addon1">
    </div>
    <div class="input-group w-10 mb-3">
        <input type="submit" class="btn btn-primary" name="insert_categ_title" value="Añadir Categoria" aria-label="Username" aria-describedby="basic-addon1">
    </div>
</form>